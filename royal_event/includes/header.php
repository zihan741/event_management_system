      ...
      <div class="row">
        ...
        <div class="col-md-4">
           <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 70px; width: auto;" src="" alt=""></a>
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch w-100">
    ...
    <ul class="navbar-nav navbar-nav-left">
        ...
        {  
         ...
         <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://api.whatsapp.com
          ">
